...
public class Normalize {
    ...
    public class NormalizeMapper extends Mapper <LongWritable, DoubleArrayWritable, IntWritable,DoubleArrayWritable> {
    ...
    public class NormalizeReducer extends Reducer <IntWritable, DoubleArrayWritable, IntWritable, DoubleArrayWritable> {
    ...
    public class NormalizeCombiner extends Reducer <IntWritable, DoubleArrayWritable, IntWritable, DoubleArrayWritable> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String output= "/output/trainX.csv";
